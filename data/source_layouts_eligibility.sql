...
CREATE TABLE eligibility_payer_2 (
...
CREATE TABLE eligibility_payer_3 (
    mem_member_id_nm VARCHAR2(50),
...
CREATE TABLE eligibility_payer_4 (
...
CREATE TABLE eligibility_payer_5 (
...
CREATE TABLE eligibility_payer_6 (
...
CREATE TABLE eligibility_payer_7 (
...
CREATE TABLE eligibility_payer_8 (
...
CREATE TABLE eligibility_payer_9 (
...
CREATE TABLE eligibility_payer_10 (
...
CREATE TABLE eligibility_payer_11 (
...
CREATE TABLE eligibility_payer_12 (
    mem_member_id_id VARCHAR2(50),
    first_name_code VARCHAR2(35),
    last_name_code VARCHAR2(60),
...
CREATE TABLE eligibility_payer_13 (
...
CREATE TABLE eligibility_payer_14 (
    sub_member_id_id VARCHAR2(50),
    first_name_nm VARCHAR2(35),
    last_name VARCHAR2(60),
    date_of_birth DATE,
...
CREATE TABLE eligibility_payer_15 (
    member_id_val VARCHAR2(50),
...
CREATE TABLE eligibility_payer_16 (
    member_id_val VARCHAR2(50),
    first_name_val VARCHAR2(35),
...
CREATE TABLE eligibility_payer_17 (
...
CREATE TABLE eligibility_payer_18 (
    mem_member_id_nm VARCHAR2(50),
...
CREATE TABLE eligibility_payer_19 (
    sub_member_id_nm VARCHAR2(50),
    mem_first_name_nm VARCHAR2(35),
    last_name_val VARCHAR2(60),
    date_of_birth_nm DATE,
...
CREATE TABLE eligibility_payer_20 (
